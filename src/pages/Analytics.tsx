		...
		try {
			...
			setAnalyticsData({
				...
				recentActivity: [
					{
						user: "john_doe",
						action: "Generated resume for Google",
						time: "2 minutes ago",
					},
					{
						user: "jane_smith",
						action: "Downloaded resume for Microsoft",
						time: "5 minutes ago",
					},
					{
						user: "bob_wilson",
						action: "Generated resume for Apple",
						time: "8 minutes ago",
					},
					{
						user: "alice_brown",
						action: "Downloaded resume for Amazon",
						time: "12 minutes ago",
					},
					{
						user: "charlie_davis",
						action: "Generated resume for Meta",
						time: "15 minutes ago",
					},
				],
				monthlyStats: [
							...
							<Card className="bg-white/80 backdrop-blur-sm shadow-xl border-0">
								...
								<CardContent>
									<div className="space-y-4">
										{analyticsData.topCompanies.map(
											(company, index) => (
												<div
													key={company.name}
									...
									<div className="space-y-4">
										{analyticsData.recentActivity.map(
											(activity, index) => (
												<div
													key={index}
													className="flex items-start gap-3 p-3 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg"
												>
						...
						<Card className="bg-white/80 backdrop-blur-sm shadow-xl border-0">
							...
							<CardContent>
								<div className="grid grid-cols-6 gap-4 h-64">
									{analyticsData.monthlyStats.map(
										(stat, index) => (
											<div
												key={stat.month}
