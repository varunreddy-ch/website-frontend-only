						...
						<div className="relative z-10">
							...
							<div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
								<a
									...
									target="_blank"
									rel="noopener noreferrer"
									className="bg-white text-green-600 hover:bg-gray-100 px-10 py-5 text-xl font-bold shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-3 rounded-2xl min-w-[280px] h-[60px]"
								>
									<svg
										className="h-6 w-6"
										fill="currentColor"
