...
const PremiumUpgrade = ({ feature }: PremiumUpgradeProps) => {
	...
	const handleContactSupport = () => {
		window.open(demoFormUrl, "_blank");
	};
					...
					<CardContent className="p-8 text-center">
						...
						<p className="text-lg text-gray-600 mb-6">
							...
							{feature === "jobs"
								? "job access"
								: "analytics features"}
							, please fill out our registration form so we can
							follow up with the right plan and pricing.
						</p>
				...
				<CardContent className="p-8">
					...
					<div className="text-center bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-200">
						...
						<p className="text-gray-600 mb-3">
							Fill out the form and we'll follow up with premium
						...
						<a
							...
							className="flex items-center justify-center gap-2 text-sm text-blue-700 font-semibold hover:text-blue-800"
						>
							<FileText className="w-4 h-4" />
							<span>Open the Registration Form</span>
						</a>
					</div>
				</CardContent>
			</Card>
